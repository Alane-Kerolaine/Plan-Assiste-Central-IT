...
const inscricaoAdesao = baseSchema('inscricao-adesao', 'Inscrição / Adesão', [
  ...
  },
  {
    ...
    fields: [
      { id: 'titularNomeSocial', label: 'Nome social', type: 'text', placeholder: 'Se houver, informe o nome social', infoText: 'Conforme Portaria PGR/MPU nº 7/2018' },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'dependenteNomeSocial', label: 'Nome social', type: 'text', placeholder: 'Se houver, informe o nome social', infoText: 'Conforme Portaria PGR/MPU nº 7/2018' },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'especialNomeSocial', label: 'Nome social', type: 'text', placeholder: 'Se houver, informe o nome social', infoText: 'Conforme Portaria PGR/MPU nº 7/2018' },
...
const mudancaTipoBeneficiario = baseSchema('mudanca-tipo-beneficiario', 'Mudança de Tipo de Beneficiário', [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'mudancaEspecialNomeSocial', label: 'Nome social', type: 'text', placeholder: 'Se houver, informe o nome social', infoText: 'Conforme Portaria PGR/MPU nº 7/2018' },
